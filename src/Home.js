...
console.log('hi')
 ...
 setscroll(scroll)
    ...
    return (
        <div className={`  ${menubar ? 'home' : ''}${popout ? 'p-home' : ''} m-0 h-full  `} ref={b} onScroll={(e) => { console.log(e) }} >
            ...
            <div  className=' h-121 sm:h-auto  sm:pb-0   pt-24 sm:pt-36 md:pt-40 lg:pt-40 flex flex-col  sm:gap-0 sm:block'>
