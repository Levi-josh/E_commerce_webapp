  ...
  setuser('')
    ...
    return (
        <div className={`flex justify-center ${bgcolor} ${textcolor} fixed items-center w-full  h-screen `}>
            ...
            <div className={`w-130 sm:w-140  lg:w-130  xl:w-140 lg:h-96  rounded-xl overflow-hidden ${mode.colormode?'addShadow2':'addShadow'}   justify-center lg:items-center   items-start flex flex-col lg:flex-row  gap-3 sm:gap-6  lg:gap-12 `}>
                ...
                <form  onSubmit={handleSubmit}className='flex flex-col gap-3 sm:gap-4 lg:gap-5 pb-3 sm:pb-6  w-full  lg:pr-12 lg:pl-0 px-3 sm:px-7 lg:px-6   '>
                    ...
                    <input type='password' placeholder='Password'  value={formData.input2} name="input2" onChange={handlechange}  className={`outline-none   ${mode.colormode?'bg-stone-800 ':'bg-gray-200'} py-1 lg:py-2 pl-2  ${mode.colormode?'text-white placeholder:text-white':'text-black placeholder:text-black'}  w-full  `} />
                    </div>
                    </div>
