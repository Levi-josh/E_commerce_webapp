                    ...
                    <section className='  pt-10 sm:pt-14     '>
                        ...
                        <div className={`w-full h-auto ${bgcolor}  flex flex-col sticky top-0 py-5`}>
                            ...
                            <div className='flex   top-20 sm:top-24   sm:overflow-visible  overflow-hidden  w-full pl-3 sm:px-5 md:pl-0 gap-5 sm:gap-2 xl:gap-6  sm:justify-center  '>
                                <div ref={firstref} className={`block  sm:translate-x-0`}> <div className='flex items-center   text-lg font-bold gap-3 w-44 sm:w-48  md:w-52 lg:w-60'>   <div className={`w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9 rounded-3xl text-white ${shopitems?.progess ? 'bg-brown' : mode.colormode?'bg-stone-800':'bg-gray-300'} flex justify-center items-center`}>{shopitems?.progess ? <FaCheck className='text-sm' /> : <p className={`${mode.colormode?'text-white':'text-black'}`}>1</p>}</div><div className={`flex ${shopitems?.progess ? ' text-brown' : mode.colormode?'text-white':'text-black'}`}>Shopping <span className='flex flex-nowrap'>cart</span></div></div><div className={`${shopitems?.progess ? 'border-brown' : mode.colormode?'border-stone-800':'border-gray-300'} w-full border mt-4`}></div></div>
                                <div ref={secondref} className={`block   sm:translate-x-0 `}>   <div className='flex items-center text-lg font-bold gap-3 w-44 sm:w-48 md:w-52 lg:w-60'><div className={`w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9  rounded-3xl text-white ${checkitems?.progess ? ' bg-brown ' : mode.colormode?'bg-stone-800':'bg-gray-300'} flex justify-center items-center`}>{checkitems?.progess ? <FaCheck className='text-sm' /> : <p className={`${mode.colormode?'text-white':'text-black'}`}>2</p>}</div><div className={`flex ${checkitems?.progess ? ' text-brown' : mode.colormode?'text-white':'text-black'}`}>Check  <span className='flex flex-nowrap'>out detail</span></div></div><div className={`${checkitems?.progess ? 'border-brown' : mode.colormode?'border-stone-800':'border-gray-300'} w-full border mt-4`}></div></div>
                                <div ref={thirdref} className={`block   sm:translate-x-0 `}>   <div className='flex items-center text-lg font-bold gap-3 w-44 sm:w-48 md:w-52 lg:w-60'><div className={`w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9 rounded-3xl text-white ${changecart3 ? 'bg-brown ' :  mode.colormode?'bg-stone-800':'bg-gray-300'} flex justify-center items-center`}>{changecart3 ? <FaCheck className='text-sm' /> : <p className={`${mode.colormode?'text-white':'text-black'}`}>3</p>}</div><div className={`flex ${changecart3 ? 'text-brown' : mode.colormode?'text-white':'text-black'} `}>Complete</div></div><div className={changecart3 ? `border-brown w-full border mt-4 ` : `${mode.colormode?'border-stone-800':'border-gray-300'} w-full border mt-4`}></div></div>
                            </div>
                        </div>
