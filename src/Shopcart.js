        ...
        <div className='pt-6 sm:pt-8'>
            <div className='lg:flex items-start lg:w-110 m-auto gap-5 lg:mt-10 '>
                <div className=' lg:w-130 lg:flex lg:flex-col lg:justify-center items-center  '>
                    ...
                    <ul className='border-b border-black pb-6 pl-3 sm:pl-5 sm:pb-7 justify-between  lg:flex lg:pb-0 lg:pl-0  lg:w-full'>
                    ...
                    <div className='flex gap-5 justify-center border-b lg:w-full   border-gray-400 mt-5 sm:mt-8  sm:pb-8  sm:m-auto pb-5 lg:flex lg:justify-between  '>
